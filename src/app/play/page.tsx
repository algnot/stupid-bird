...
export default function Home() {
  ...
  const [characterImage, setCharacterImage] = useState<string>("./bird.png");
  ...
  const getUserStstus = async () => {
    ...
    setCharacterImage(response?.character?.info?.image ?? "./bird.png");
  ...
  return (
    <FlappyBird
      ...
      INCRESE_SECONDE={gameConfig?.INCRESE_SECONDE ?? 1}
